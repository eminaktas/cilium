...
func (r *gatewayReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	cec, svc, ep, err := r.translator.Translate(&model.Model{HTTP: httpListeners, TLSPassthrough: tlsPassthroughListeners, L4: l4Listeners})
	if err != nil {
	...
	if svc == nil {
		err = fmt.Errorf("no Service generated for Gateway")
	...
	if err = r.ensureGatewayL4Config(ctx, gw, l4Listeners); err != nil {
